        ...
        <div class="container-fluid">
            ...
            <div class="box_general">
                ...
                <div class="header_box">
                    <h2 class="d-inline-block">My Queries</h2>
                    <div class="filter">
                    ...
                    <ul>
                        @foreach ($queries as $query)
                            <li>
                                ...
                                <h4> {{ $query->typeOfMaintenance }} <i
                                        class="badge badge-warning">{{ $query->status }}</i>
                                </h4>
                                <ul class="booking_details">
                                    <li><strong>Inspection Date</strong> {{ $query->inspectionDate }} </li>
                                    <li><strong>Prefered Time</strong> {{ $query->preferedTime }} </li>
                                    <li><strong>Booking time</strong> 10.20AM</li>
                                    <li><strong>Case ID </strong> {{ $query->id }} </li>
                                    <li><strong>Telephone</strong> {{ $query->telephone }} </li>
                                ...
                                <ul class="buttons">
                                    ...
                                    <li><a href="{{ url('request_details') }}" class="btn_1 gray delete"><i
                                                class="fa fa-fw fa-times-circle-o"></i> View Request Details</a></li>
                                </ul>
